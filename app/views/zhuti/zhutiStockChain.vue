      ...
      <template v-if="chainStockList.length">
        ...
        <table class="stocklist-pool-table">
          <thead v-if="anchorFixed" class="stocklist-pool-thead-chain fixed">
                <th style="width:500px;" class="stocklist-pool-th stocklist-pool-th-reason">股票名称</th>
                <sort-thead style="width:70px;" label="最新价" @sort="startSortChain" :sort-rule="sortRule" target-prop="last_px" />
                <sort-thead style="width:70px;" label="涨跌幅" @sort="startSortChain" :sort-rule="sortRule" target-prop="px_change_rate" />
                <sort-thead style="width:70px;" label="换手率" @sort="startSortChain" :sort-rule="sortRule" target-prop="turnover_ratio" />
                <sort-thead style="width:70px;" :two-line="true" label="自由流<br/>通市值" @sort="startSortChain" :sort-rule="sortRule" target-prop="circulation_value" />
                <sort-thead style="width:70px;" label="总市值" @sort="startSortChain" :sort-rule="sortRule" target-prop="market_value" />
                <sort-thead style="width:70px;" label="市盈率"  @sort="startSortChain" :sort-rule="sortRule" target-prop="pe_rate" />
                <sort-thead style="width:76px;"  label="资金流向" @sort="startSortChain" :sort-rule="sortRule" target-prop="flow" />
                <th class="stocklist-pool-th">叠加</th>
          </thead>
        </table>
