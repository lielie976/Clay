  ...
  <table v-if ="topFixed" class="table hit-pool__table fixed">
    ...
    <thead class="hit-pool__table-head">
      <tr>
        ...
        <th @click="startSort('px_change_rate')" :class="{'sort_target':'px_change_rate' == sortTarget}" target="px_change_rate" class="stock-sort"><abbr title="涨跌幅">涨跌幅</abbr><span class="icon"><i :class="getSortStatus('px_change_rate')" class="iconfont " ></i></span></th>
        ...
        <th :class="{'sort_target':'last_boom_time' == sortTarget}" @click="startSort('last_boom_time')"  target="last_boom_time" class="stock-sort"><abbr title="最后炸板">最后炸板</abbr><span class="icon"><i :class="getSortStatus('last_boom_time')" class="iconfont icon-paixumorenzhuangtai" ></i></span></th>
        <th :class="{'sort_target':'open_count' == sortTarget}"  @click="startSort('open_count')"  target="open_count" class="stock-sort"><abbr title="开板次数">开板次数</abbr><span class="icon"><i :class="getSortStatus('open_count')" class="iconfont icon-paixumorenzhuangtai" ></i></span></th>
        <th :class="{'sort_target':'continue_board_count' == sortTarget}" @click="startSort('continue_board_count')"  target="continue_board_count" class="stock-sort"><abbr title="连板数">连板数</abbr><span class="icon"><i :class="getSortStatus('continue_board_count')" class="iconfont icon-paixumorenzhuangtai" ></i></span></th>
      </tr>
    </thead>
  </table>
  <table class="table hit-pool__table">
    ...
    <tbody class="table hit-pool__table-body">
      <tr :key="item.symbol" v-for="item in stockList">
          ...
          <td :class="{'sort_target':'last_boom_time' == sortTarget}" target="last_boom_time" >{{timeFormatter(item.last_boom_time)}}</td>
